...
public class GA4_1 implements GeneticAlgorithm {
  ...
  public GA4_1(String marioAIOptions, String name) {
    for (int i = 0; i < SIZE; i++) {
      currentGeneration[i] = new GA4_1Agent();
    }
  ...
  private void updateNextGeneration() {
    nextGeneration = new GA4_1Agent[SIZE];
    for (int i = ELITE_NUM; i < SIZE; i++) {
      nextGeneration[i] = new GA4_1Agent();
    }
  ...
  private BasicTask playMario(GA4_1Agent agent, boolean visual) {
